...
Jednoduchá PHP appka na nahrávanie a správu videí, ktoré sa prehrávajú na TV obrazovkách. Pôvodne bežala ako súčasť skompromitovaného WordPress webu `video.trnavavuc.sk` — vyčistené a vymigrované do samostatnej appky.
